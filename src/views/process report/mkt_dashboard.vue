...
const cards = [
  { label: "Internal Product Brief", count: 4 },
  { label: "6M Forecast", count: 4 },
  { label: "Internal Brand Name", count: 3 },
  { label: "Packaging Concurrence", count: 3 },
  { label: "Internal Price", count: 4 },
  { label: "AFPC Doc", count: 0 },
  { label: "Launching Circular", count: 0 },
];
