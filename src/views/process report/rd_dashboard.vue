...
const cards = [
  { label: "Product Brief Approval", count: 3 },
  { label: "Dev. RM Spec.", count: 4 },
  { label: "Dev. RM Receival", count: 2 },
  { label: "Formulation Concurrence", count: 4 },
  { label: "3M Stability", count: 2 },
  { label: "Recipe Doc.", count: 3 },
  { label: "DTL Doc.", count: 0 },
  { label: "PM Spec.", count: 3 },
  { label: "Change Parts PR", count: 3 },
  { label: "RM & PM Requisition", count: 2 },
  { label: "6M Stability", count: 4 },
  { label: "Annexure Doc.", count: 3 },
  { label: "Change Parts Receival", count: 3 },
  { label: "RM Receival", count: 3 },
  { label: "PM Receival", count: 3 },
  ...
  <MainLayout>
    <div class="min-h-screen bg-slate-50 p-4 sm:p-6 md:p-8">
      <div class="flex flex-col lg:flex-row lg:items-start gap-8">
        ...
        <div
          class="flex-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2"
        >
          <div
