...
const cards = [
  { label: "Recipe Approval", count: 4 },
  { label: "DTL Approval", count: 4 },
  { label: "PM Design Approval", count: 3 },
  { label: "Annexure Approval", count: 3 },
  { label: "Inclusion Approval", count: 4 },
  { label: "Price Approval", count: 5 },
  { label: "MA Certificate", count: 0 },
];
